      ...
      <div className="flex flex-col">
        <ol className="flex flex-col gap-32">
          <li className="flex flex-col gap-8">
            <span className="flex gap-8 text-5xl sm:text-7xl font-extrabold ">
              <span className="w-4 sm:w-16 text-zinc-300 dark:text-zinc-700">
                1
              </span>
            ...
            <div className="text-zinc-700 font-extralight dark:text-zinc-200 dark:font-thin">
              *{disclaimer}
            </div>

            <ul className="grid grid-cols-[repeat(auto-fill,minmax(min(180px,100%),1fr))] gap-20">
              <li className="flex flex-col gap-4 min-w-[180px] transition-[transform] sm:hover:scale-110">
          ...
          <li className="flex flex-col gap-8">
            ...
            <p className="">{appointment_only}</p>
            ...
            >
              {/* <span className="relative max-h-[40px] max-w-[40px] h-[40px] w-[40px] sm:max-h-[70px] sm:max-w-[70px] sm:h-[70px] sm:w-[70px]">
                <IconPhoneCall className="h-full w-full" />
              </span> */}
