  ...
  return (
    <div className="flex gap-32 flex-col sm:flex-row">
      <div className="flex gap-8 flex-col flex-1">
        <h3 className="flex items-center gap-4 font-extrabold text-2xl uppercase text-zinc-900 dark:text-zinc-300">
          <IconBook size={40} />
          {story}
        </h3>
        <p className="text-xl font-bold text-zinc-400 dark:text-zinc-600">
          {storyDesc}
        </p>
      </div>
      <div className="flex gap-8 flex-col flex-1">
